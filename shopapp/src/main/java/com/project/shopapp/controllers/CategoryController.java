...
public class CategoryController {
    ...
    @PostMapping("")
    //Nếu tham số là 1 object thì sao? => Data Tranfer Object = Request Object
    public ResponseEntity<?> createCategory(                //nhận cả categoryDTO và List<String> dùng "?"
